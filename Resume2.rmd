...
- Provided statistical analysis and visualization of community based ethylene oxide air sampling data that demonstrated of significant improvement in ethylene oxide concentrations after controls were instituted, and a better understanding of past and current ecommunity exposure.
- Compared blood lead and urinary arsenic levels measured in community memebers living near a former lead smelter to the age adjusted NHANES data and analyzed exposure questionnaire data. The analysis demonstrated a small, but significant increase in lead in the community, and an association of increased blood lead levels with exposure to attic dust.  
- Developed R package to perform groundwater vapor intrusion modeling using EPA's Johnson and Ettinger Model, with enhancements for visualization and  probabilistic inputs. Th package was used to efficiently generate estimates of exposure from groundwater vapor intrusion at a site with hundreds of buildings and scores of chemicals.  
...
- Developed a package of R functions that download data, run AERMET, AERMINUTE and AERSURFACE,  and performing quality assurance of output. This package was adapted and used by U.S. EPA to perform AERMET analysis at over 800 sites across the country, as well as used by ATSDR to support site specific modeling.
...
--------------------------------------------------------------------------------
Amateur Radio: Amateur Extra Class License KE4MKG

Georgia Appalachian Trail Club: Section 9.13 maintainer, Level 1 Sawyer (chainsaw)
